...
def openGriber():
  ...
  while (True):
  step_count_92352259_ad9a_43ae_be98_13b461d18ca2 = step_count_92352259_ad9a_43ae_be98_13b461d18ca2 + 1
  sync()
  end
  end
  run Step_Counter_Thread_e5297bbc_e52c_447c_aeed_8a17c02603ec()
  ...
  RG2(target_width=100, target_force=40, payload=0.5, set_payload=False, depth_compensation=True, slave=False)
end
  """
boilerplateCloseRG2 =  """
def closeGriber():
  ...
  set_tool_voltage(24)
  set_tcp(p[0,0,0.18659,0,-0,0])
  RG2(target_width=0, target_force=40, payload=0.5, set_payload=False, depth_compensation=True, slave=False)
end
  """

openRG2 = str.encode(boilerplateOpenRG2)
closeRG2 = str.encode(boilerplateCloseRG2)
